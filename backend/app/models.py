...
class Consultation(Base):
    ...
    speechkit_operation_id: Mapped[str | None] = mapped_column(String(255), nullable=True)
    speechkit_started_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    speechkit_last_poll_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    recognition_empty_polls: Mapped[int] = mapped_column(Integer, default=0)
    error_category: Mapped[str | None] = mapped_column(String(32), nullable=True)
    evaluation_chunks_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    processing_attempts: Mapped[int] = mapped_column(Integer, default=0)
    stage_first_failure_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    step_running: Mapped[bool] = mapped_column(Integer, default=0)
    worker_interruptions: Mapped[int] = mapped_column(Integer, default=0)
    processing_generation: Mapped[int] = mapped_column(Integer, default=0)
    ...
    remote_export_status: Mapped[str] = mapped_column(String(32), default="pending")
    remote_export_queued_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_export_lease_until: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_export_next_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_export_first_failure_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_export_attempts: Mapped[int] = mapped_column(Integer, default=0)
    remote_export_error: Mapped[str | None] = mapped_column(Text, nullable=True)
    remote_audio_path: Mapped[str | None] = mapped_column(String(1024), nullable=True)
    remote_audio_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    remote_exported_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_restore_status: Mapped[str | None] = mapped_column(String(32), nullable=True)
    remote_restore_queued_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_restore_lease_until: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    remote_restore_error: Mapped[str | None] = mapped_column(Text, nullable=True)
